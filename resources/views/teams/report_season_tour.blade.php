                ...
                <div class="block-season-matches-body">
                    <div class="report-block-header">
                        <div class="block-season-matches-body-header">
                            @if($report_tour_one->sequence_number == 1)
                                <a><</a>
                            @else
                                <a href="/teams/report/season/{{$season_one->id}}/report_tour/{{$report_tour_one->sequence_number-1}}/"><</a>
                            @endif

                            <p>
                                Звіт матчу {{ date_create($report_tour_one->date_tour)->Format('d.m.Y')}}
                                тур {{$report_tour_one->tour}}
                            </p>
                            @if(count($season_one->report_tour) == $report_tour_one->sequence_number)
                                <a>></a>
                            @else
                                <a style="float: left;"
                                   href="/teams/report/season/{{$season_one->id}}/report_tour/{{$report_tour_one->sequence_number+1}}/">></a>
                            @endif
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="report-block-body-image">
                                    <img src="/uploads/report/original/{{$report_tour_one->report[0]->image}}">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="report-block-body-description">
                                            <p class="report-block-body-description-title">
                                                {{$report_tour_one->report[0]->teams}}
                                            </p>

                                            <p class="report-block-body-description-title-value-goals">
                                                {{$report_tour_one->report[0]->teams_goals}}
                                            </p>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="report-block-body-description">
                                            ...
                                            <?php $i = 0; ?>
                                            @foreach($report_tour_one->report[0]->report_goals as $goals)
                                                <?php $i++; ?>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="report-block-body-description">
                                            ...
                                            <p class="report-block-body-description-title-value-best-player">
                                                {!! str_replace(' ', '<br>', $report_tour_one->report[0]->best_player) !!}
                                            </p>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="report-block-body-description">
                                            ...
                                            <?php $i = 0; ?>
                                            @foreach($report_tour_one->report[0]->report_replacements as $goals)
                                                <?php $i++; ?>
                                                <p class="report-block-body-description-title-value-report-goals">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="report-block-body-description">
                                            ...
                                            <table class="table">
                                                ...
                                                <tr>
                                                    <th>
                                                        {{$report_tour_one->report[0]->count_games}}
                                                    </th>
                                                    <th>
                                                        {{$report_tour_one->report[0]->count_win}}
                                                    </th>
                                                    <th>
                                                        {{$report_tour_one->report[0]->count_draw}}
                                                    </th>
                                                    <th>
                                                        {{$report_tour_one->report[0]->count_loser}}
                                                    </th>
                                                    <th>
                                                        {{$report_tour_one->report[0]->count_goals}}
                                                    </th>
                                                    <th>
                                                        {{$report_tour_one->report[0]->count_missing}}
                                                    </th>
                                                    <th>
                                                        {{$report_tour_one->report[0]->difference}}
                                                    </th>
                                                    <th>
                                                        {{$report_tour_one->report[0]->points}}
                                                    </th>
                                                </tr>
                                                </tbody>
                                            </table>
