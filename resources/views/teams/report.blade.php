                ...
                <div class="block-season-matches-body">
                    <div class="report-block-header">
                        <div class="block-season-matches-body-header">
                            ...
                            <p>
                                Звіт матчу {{ date_create($season[0]->report_tour[0]->date_tour)->Format('d.m.Y')}}
                                тур {{$season[0]->report_tour[0]->tour}}
                            </p>
                            <a style="float: left;"
                               href="/teams/report/season/{{$season[0]->id}}/report_tour/{{$season[0]->report_tour[0]->sequence_number+1}}/">></a>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="report-block-body-image">
                                    <img src="/uploads/report/original/{{$season[0]->report_tour[0]->report[0]->image}}">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="report-block-body-description">
                                            <p class="report-block-body-description-title">
                                                {{$season[0]->report_tour[0]->report[0]->teams}}
                                            </p>

                                            <p class="report-block-body-description-title-value-goals">
                                                {{$season[0]->report_tour[0]->report[0]->teams_goals}}
                                            </p>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="report-block-body-description">
                                            ...
                                            <?php $i = 0; ?>
                                            @foreach($season[0]->report_tour[0]->report[0]->report_goals as $goals)
                                                <?php $i++; ?>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="report-block-body-description">
                                            ...
                                            <p class="report-block-body-description-title-value-best-player">
                                                {!! str_replace(' ', '<br>', $season[0]->report_tour[0]->report[0]->best_player) !!}
                                            </p>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="report-block-body-description">
                                            ...
                                            <?php $i = 0; ?>
                                            @foreach($season[0]->report_tour[0]->report[0]->report_replacements as $goals)
                                                <?php $i++; ?>
                                                <p class="report-block-body-description-title-value-report-goals">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="report-block-body-description">
                                            ...
                                            <table class="table">
                                                ...
                                                <tr>
                                                    <th>
                                                        {{$season[0]->report_tour[0]->report[0]->count_games}}
                                                    </th>
                                                    <th>
                                                        {{$season[0]->report_tour[0]->report[0]->count_win}}
                                                    </th>
                                                    <th>
                                                        {{$season[0]->report_tour[0]->report[0]->count_draw}}
                                                    </th>
                                                    <th>
                                                        {{$season[0]->report_tour[0]->report[0]->count_loser}}
                                                    </th>
                                                    <th>
                                                        {{$season[0]->report_tour[0]->report[0]->count_goals}}
                                                    </th>
                                                    <th>
                                                        {{$season[0]->report_tour[0]->report[0]->count_missing}}
                                                    </th>
                                                    <th>
                                                        {{$season[0]->report_tour[0]->report[0]->difference}}
                                                    </th>
                                                    <th>
                                                        {{$season[0]->report_tour[0]->report[0]->points}}
                                                    </th>
                                                </tr>
                                                </tbody>
                                            </table>
